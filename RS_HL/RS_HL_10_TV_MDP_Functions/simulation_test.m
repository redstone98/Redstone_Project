function [time_list, reward_list, state_list, state_value_list] = simulation_test(start_time,start_state,MDP,time_index_vector, destination_state)
...
state_value_list = [state_value_list(state_value_list ~=0);0];
