function MDP = policy_evaluation_process(MDP, time_index_vector,state_transition_matrix,policy_iteration_count,gamma)
...
sat_to_sat_contact_matrix =  state_transition_matrix(:,:,t_n);
